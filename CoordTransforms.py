...
def rv2coe(r, v, mu = 398600.4418):
    ...
    ----------
    r: array (3, n)
       Position of the body in 3 dim. Measured using center of Earth as origin. (km)
    v: array (3, n)
       Velocity of the body in 3 dim relative to Earth. (km / s)
    ...
    # Semi-Major axis, a
    a = 1 / ((2/norm(r,axis=1)) - ((norm(v, axis=1)**2) / mu))
